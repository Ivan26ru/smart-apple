...
register_nav_menus(array( // Регистрируем 2 меню
	'top' => 'Верхнее', // Верхнее
	'bottom' => 'Внизу', // Внизу
	'service-phone' => 'ремонт телефонов', // Ремонт техники главная страница
	'service-plansh' => 'ремонт планшетов', // Ремонт техники главная страница
	'service-notebook' => 'ремонт ноутбуков', // Ремонт техники главная страница
	'service-ebook' => 'ремонт электронных книг' // Ремонт техники главная страница
));
...
register_sidebar(array( // регистрируем левую колонку, этот кусок можно повторять для добавления новых областей для виджитов
	'name' => 'Сайдбар2', // Название в админке
	'id' => "sidebar2", // идентификатор для вызова в шаблонах
	'description' => 'Обычная колонка в сайдбаре', // Описалово в админке
	'before_widget' => '<div id="%1$s" class="">', // разметка до вывода каждого виджета
	'after_widget' => "</div>\n", // разметка после вывода каждого виджета
	'before_title' => '<span class="widgettitle">', //  разметка до вывода заголовка виджета
	'after_title' => "</span>\n", //  разметка после вывода заголовка виджета
));
...
if (!function_exists('add_styles')) { // если ф-я уже есть в дочерней теме - нам не надо её определять
	function add_styles() { // добавление стилей
		...
		wp_enqueue_style( 'my-style', get_template_directory_uri().'/my-style.css' ); // мои стили шаблона
	}
}
